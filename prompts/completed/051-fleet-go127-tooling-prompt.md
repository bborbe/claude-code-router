---
status: completed
summary: Reordered format target so gofmt runs last after golines (with the normalization comment), bumped golangci-lint to v2.13.1 and errcheck to v1.20.0 in tools.env, ran gofmt -w across all .go files (no changes needed), removed the dead providerHandler nil guard that the v2.13.1 staticcheck bump surfaced, and added the CHANGELOG Unreleased entry — make precommit exits 0
execution_id: claude-code-router-go127-exec-051-fleet-go127-tooling-prompt
dark-factory-version: dev
created: "2026-08-21T12:02:45Z"
queued: "2026-08-21T12:02:45Z"
started: "2026-08-21T12:02:46Z"
completed: "2026-08-21T12:13:14Z"
---
